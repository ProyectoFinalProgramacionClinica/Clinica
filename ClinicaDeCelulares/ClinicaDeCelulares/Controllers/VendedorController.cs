...
namespace ClinicaDeCelulares.Controllers
{
    public class VendedorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdVendedor,NombreVendedor,Cedula,Telefono")] Vendedor vendedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdVendedor,NombreVendedor,Cedula,Telefono")] Vendedor vendedor)
        {
